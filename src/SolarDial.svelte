<script>
  ...
  $: {
    ...
    sunriseAngle = differenceInSeconds(midnight,  times.sunrise) / dayLength * 360;
    sunsetAngle = differenceInSeconds(midnight, times.sunset) / dayLength * 360;
...
<svg width={400} height={400} viewBox="0 0 200 200" style="color: white;">
  <g transform="translate(100, 100)">
    ...
    <g transform={`rotate(${hour * 15})`}>
      <line x1={90} y1={0} x2={97} y2={0} stroke="currentColor" />
      {#if !(hour % 2)}
        <text
          x={0}
          y={85}
